...
class GPTPrompts():
    def __init__(self) -> None:
        ...
        self.summarize_prompt: str = """
            ...
            critical information, like factual numbers/percentages. 
            
            Return only the summarized text prefixed with 'Summary for Article X:', where X is the article number.
            <<START>>
            """
